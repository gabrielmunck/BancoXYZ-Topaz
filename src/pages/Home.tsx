    ...
    return (
        <div className="flex flex-1 items-center justify-center w-full bg-background-darker">
            <div className="flex flex-1 w-[95%] h-screen bg-background-dark">
                <div className="absolute top-10 left-0 w-full h-screen overflow-hidden">
                    <svg
                ...
                <div className="flex flex-col w-full z-50">
                    ...
                    <div className="px-10 pt-20">
                        <h2 className="text-text-light text-center text-4xl font-bold mb-10" style={{ textShadow: "2px 2px 4px rgba(0, 0, 0, 0.6)" }}>
                            Olá, {user.name}!
                        </h2>
